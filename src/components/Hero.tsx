...
import { ArrowRight, Play, Users, BookOpen, Award, Star, CheckCircle2, GraduationCap, Monitor, Rocket, Zap, Trophy, Target } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              style={{
                boxShadow: "0 50px 100px -20px rgba(0,0,0,0.25), 0 30px 60px -30px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.1)"
              }}
            >
              {/* macOS Window Header */}
              ...
              >
                ...
                <motion.div
                  ...
                  initial={{ x: "-100%" }}
                  animate={{ x: "200%" }}
                  transition={{ duration: 2, delay: 1.2, repeat: Infinity, repeatDelay: 4 }}
                />
                ...
                <div className="flex-1 p-5 bg-white dark:bg-oxford">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-1 text-xs">
                        ...
                        <span className="text-oxford dark:text-white font-medium">4.9</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center justify-between text-xs mb-2">
                      <span className="text-gray-500 dark:text-white/40">{t("progressLabel")}</span>
            ...
            <motion.div
              ...
              transition={{ 
                ...
                y: { delay: 1.7, duration: 2.5, repeat: Infinity, ease: "easeInOut" },
                rotate: { delay: 1.7, duration: 3, repeat: Infinity, ease: "easeInOut" }
              }}
            ...
            <motion.div
              ...
              transition={{ 
                ...
                y: { delay: 1.9, duration: 2, repeat: Infinity, ease: "easeInOut" }
              }}
            ...
            >
              <div className="bg-white dark:bg-oxford-light rounded-full shadow-lg px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-oxford dark:text-white">4.9</span>
              </div>
            </motion.div>
